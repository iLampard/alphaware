...
INDEX_FACTOR.date_index = 'trade_date'
INDEX_FACTOR.sec_index = 'ticker'
INDEX_FACTOR.full_index = ['trade_date', 'ticker']
...
INDEX_INDUSTRY_WEIGHT.date_index = 'trade_date'
INDEX_INDUSTRY_WEIGHT.industry_index = 'industry_code'
INDEX_INDUSTRY_WEIGHT.full_index = ['trade_date', 'industry_code']
INDEX_INDUSTRY_WEIGHT.col_name = 'weight'

INDEX_SELECTOR = namedtuple('INDEX_SELECTOR', ['date_index', 'sec_index', 'col_name'])
INDEX_SELECTOR.date_index = 'trade_date'
INDEX_SELECTOR.sec_index = 'ticker'
...
INDEX_RETURN.date_index = 'trade_date'
